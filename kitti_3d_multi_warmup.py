...
def Config():
    ...
    conf.ilbls = ["Animal","Trailer","EmergencyVehicle","CaravanTransporter"]
    conf.lbls = ['Car', 'Pedestrian',"Truck","VanSUV",'Cyclist',"Bus","MotorBiker","Bicycle","UtilityVehicle","Motorcycle"]
